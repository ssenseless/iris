...
p0_weights = col_perceptron(p0_data, p0_weights, eta=0.1, maxiter=3)
p1_weights = col_perceptron(p1_data, p1_weights, eta=0.1, maxiter=3)
p2_weights = col_perceptron(p2_data, p2_weights, eta=0.1, maxiter=3)

testexamples = pd.DataFrame({'sepal length': [5.4, 6.0, 6.8, 5.2, 5.9],
...
testexamples = pd.DataFrame({'sepal length': [(x % 80) / 10.0 for x in range(1, (80 ** 6))],
                             'sepal width': [(x / 80) / 10.0 for x in range(1, (80 ** 6))],
                             'petal length': [(x / (80 ** 2)) / 10.0 for x in range(1, (80 ** 6))],
                             'petal width': [(x / (80 ** 3)) / 10.0 for x in range(1, (80 ** 6))],
                             'class': [0 for x in range(1, (80 ** 6))]})
